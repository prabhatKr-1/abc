...
func TestSignup_InvaliJSON(t *testing.T) {
	gin.SetMode(gin.TestMode)
	testutils.SetupTestDB()
	...
	assert.Equal(t, http.StatusBadRequest, w.Code, "Missing input fields")
}
...
func TestCreateReaderUser_InvalidJSON(t *testing.T) {
	gin.SetMode(gin.TestMode)
	testutils.SetupTestDB()
